...
#49. Faça um programa para leia o horário (hora, minuto e segundo) de inicio e a duração, em segundos, de uma experiéncia bioldgica. O programa deve resultar com #o novo horario (hora, minuto e segundo) do termino da mesma. 
...
#52. Trés amigos jogaram na loteria. Caso eles ganhem, o prémio deve ser repartido proporcionalmente ao valor que cada deu para a realizagao da aposta. Faga um #programa que leia quanto cada apostador investiu, o valor do prémio, e imprima quanto cada um ganharia do prémio com base no valor investido. 
